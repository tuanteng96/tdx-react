...
function ItemsCareHistory({ item, index, rowData }) {
      ...
      >
        {addMutation.isLoading && (
          <div role='status'>
            <svg
              aria-hidden='true'
              className='text-gray-200 w-7 h-7 animate-spin fill-blue-600'
              viewBox='0 0 100 101'
              fill='none'
        ...
        {!addMutation.isLoading && <TrashIcon className='w-5' />}
      </button>
    </div>
  )
}

export default ItemsCareHistory
